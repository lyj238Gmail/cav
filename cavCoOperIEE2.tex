...
Suppose that the number of actual parameters occurring in $cf$ is $n$, and that of formal parameters occurring in $r$ is $n'$, we choose $n'$--element subset among $\{1,...,(n+n')\}$ to instantiate $r$. Namely a $n'$-permutation of $n+n'$ will be regarded as a group of rule parameters to instantiate $r$. For instance, let $n=n'=2$, then [1,2], [2,3], [2,4] are groups of rule parameters to instantiate $r$. 
