...
\lyj{
Theorem \ref{consistentLemma} is our main weapon  to prove. Let us recall the proof goal set in \ref{example1}:  the mutual exclusion property holds for each reachable state of the mutual-exclusion protocol. %Let us recall example \ref{example1} and  \ref{example2}.
...
\lyj{Notice that there is a close 
